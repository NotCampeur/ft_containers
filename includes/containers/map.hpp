...
/*   Updated: 2022/03/08 04:02:34 by ldutriez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class map
	{
		...
		public:
			...
			{
				return iterator(const_cast<typename rbtree_type::node_type *>(_tree.lower_bound(value_type(key, mapped_type())).base()), _tree.limit());
			}
			...
			iterator upper_bound(const key_type& key)
			{
				...
				return iterator(const_cast<typename rbtree_type::node_type *>(_tree.upper_bound(value_type(key, mapped_type())).base()), _tree.limit());
			}
