...
/*   Updated: 2022/01/21 19:02:42 by ldutriez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	template<class InputIterator>
	long do_distance (InputIterator first, InputIterator last, ft::random_access_iterator_tag)
	{
		return (last - first);
	}
	...
	template<class InputIterator>
	long do_distance (InputIterator first, InputIterator last, ft::input_iterator_tag)
	{
		int sum(0);
		while (first != last)
		{
