...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   new_red_black_tree_iterator.hpp                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
namespace ft
{
	...
	struct red_black_tree_iterator : ft::iterator<ft::bidirectional_iterator_tag, I>
	{
		...
		red_black_tree_iterator() : _ptr(NULL), _limit(NULL) {};
		red_black_tree_iterator(pointer ptr, pointer limit) : _ptr(ptr), _limit(limit) {};
		red_black_tree_iterator(const red_black_tree_iterator<I>& other) : _ptr(other._ptr), _limit(other._limit) {};
		...
		red_black_tree_iterator& operator--() { _ptr = prev_inorder(_ptr, _limit); return (*this); }
		red_black_tree_iterator operator--(int) { red_black_tree_iterator tmp(*this); _ptr = prev_inorder(_ptr, _limit); return tmp; }
	...
	struct const_red_black_tree_iterator : ft::iterator<ft::bidirectional_iterator_tag, I>
	{
		...
		public:
			...
			const_red_black_tree_iterator(pointer ptr, pointer limit) : _ptr(ptr), _limit(limit) {};
			const_red_black_tree_iterator(const const_red_black_tree_iterator<I>& other) : _ptr(other._ptr), _limit(other._limit) {};
			const_red_black_tree_iterator(const ft::red_black_tree_iterator<I>& other) : _ptr(other._ptr), _limit(other._limit) {};
			...
			const_red_black_tree_iterator& operator--() { _ptr = prev_inorder(_ptr, _limit); return (*this); }
			const_red_black_tree_iterator operator--(int) { const_red_black_tree_iterator tmp(*this); _ptr = prev_inorder(_ptr, _limit); return tmp; }
