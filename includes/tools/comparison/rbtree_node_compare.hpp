...
/*   Updated: 2022/03/06 16:53:17 by ldutriez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	template <typename T, typename Compare>
	bool	is_inferior_in_key(const ft::RedBlackTreeNode<T, Compare> * node, const T & value)
	{
		Compare comp;
	...
	template <typename T, typename Compare>
	bool	is_inferior_in_key(const ft::RedBlackTreeNode<T, Compare> * node1, const ft::RedBlackTreeNode<T, Compare> * node2)
	{
		Compare comp;
	...
	bool	is_inferior_in_key(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node1, const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node2)
	{
		Compare comp;
	...
	template <typename U, typename V, typename Compare>
	bool	is_inferior_in_key(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node, const ft::pair<U, V> & value)
	{
		Compare comp;
	...
	// A specialisation of the above function, if the type is a pair but compare a key.
	template <typename U, typename V, typename Compare>
	bool	is_inferior_in_key(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node, const U & value)
	{
		Compare comp;
	...
	template <typename T, typename Compare>
	bool	is_superior_in_key(const ft::RedBlackTreeNode<T, Compare> * node, const T & value)
	{
		Compare comp;
	...
	// A specialisation of the above function, if the type is classic but compare another node.
	template <typename T, typename Compare>
	bool	is_superior_in_key(const ft::RedBlackTreeNode<T, Compare> * node1, const ft::RedBlackTreeNode<T, Compare> * node2)
	{
		Compare comp;
	...
	template <typename U, typename V, typename Compare>
	bool	is_superior_in_key(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node, const ft::pair<U, V> & value)
	{
		Compare comp;
	...
	template <typename U, typename V, typename Compare>
	bool	is_superior_in_key(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node, const U & value)
	{
		Compare comp;
	...
	// Templated function which take a Compare to tell if the argument node is less than the given value.
	template <typename T, typename Compare>
	bool	is_inferior(const ft::RedBlackTreeNode<T, Compare> * node, const T & value)
	{
		Compare comp;
	...
	// A specialisation of the above function, if the type is classic but compare another node.
	template <typename T, typename Compare>
	bool	is_inferior(const ft::RedBlackTreeNode<T, Compare> * node1, const ft::RedBlackTreeNode<T, Compare> * node2)
	{
		Compare comp;
	...
	template <typename U, typename V, typename Compare>
	bool	is_inferior(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node1, const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node2)
	{
		Compare comp;
	...
	// A specialisation of the above function, if the type is a pair but compare a key.
	template <typename U, typename V, typename Compare>
	bool	is_inferior(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node, const ft::pair<U, V> & value)
	{
		Compare comp;
	...
	// Templated function which take a Compare to tell if the argument node is greter than the given value.
	template <typename T, typename Compare>
	bool	is_superior(const ft::RedBlackTreeNode<T, Compare> * node, const T & value)
	{
		Compare comp;
	...
	// A specialisation of the above function, if the type is classic but compare another node.
	template <typename T, typename Compare>
	bool	is_superior(const ft::RedBlackTreeNode<T, Compare> * node1, const ft::RedBlackTreeNode<T, Compare> * node2)
	{
		Compare comp;
	...
	template <typename U, typename V, typename Compare>
	bool	is_superior(const ft::RedBlackTreeNode<ft::pair<U, V>, Compare> * node, const ft::pair<U, V> & value)
	{
		Compare comp;
