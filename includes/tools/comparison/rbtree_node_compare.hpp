...
/*   Updated: 2022/02/28 00:14:46 by ldutriez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T, typename Compare, typename Alloc>
bool	is_inferior_in_key(const RedBlackTreeNode<T, Compare, Alloc> * node, const T & value)
{
	Compare comp;
...
bool	is_inferior_in_key(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node1, const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node2)
{
	Compare comp;
...
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_inferior_in_key(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node, const ft::pair<U, V> & value)
{
	Compare comp;
...
// A specialisation of the above function, if the type is a pair but compare a key.
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_inferior_in_key(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node, const U & value)
{
	Compare comp;
...
template <typename T, typename Compare, typename Alloc>
bool	is_superior_in_key(const RedBlackTreeNode<T, Compare, Alloc> * node, const T & value)
{
	Compare comp;
...
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_superior_in_key(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node, const ft::pair<U, V> & value)
{
	Compare comp;
...
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_superior_in_key(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node, const U & value)
{
	Compare comp;
...
// Templated function which take a Compare to tell if the argument node is less than the given value.
template <typename T, typename Compare, typename Alloc>
bool	is_inferior(const RedBlackTreeNode<T, Compare, Alloc> * node, const T & value)
{
	Compare comp;
...
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_inferior(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node1, const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node2)
{
	Compare comp;
...
// A specialisation of the above function, if the type is a pair but compare a key.
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_inferior(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node, const ft::pair<U, V> & value)
{
	Compare comp;
...
// Templated function which take a Compare to tell if the argument node is greter than the given value.
template <typename T, typename Compare, typename Alloc>
bool	is_superior(const RedBlackTreeNode<T, Compare, Alloc> * node, const T & value)
{
	Compare comp;
...
template <typename U, typename V, typename Compare, typename Alloc>
bool	is_superior(const RedBlackTreeNode<ft::pair<U, V>, Compare, Alloc> * node, const ft::pair<U, V> & value)
{
	Compare comp;
